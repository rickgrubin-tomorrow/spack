...
class PyCylcUiserver(PythonPackage):
    ...
    # Versions 1.5.1 and 1.6.1 are available at PyPI, but not at the URL that is considered
    # canonical by Spack - https://github.com/spack/spack/issues/48479
    version("1.6.1", commit="81782affa28ef7a7f8b4c2fe58c82800dc5cb542")
    ...
    depends_on("py-cylc-flow@8.4", when="@1.6.1", type=("build", "run"))
